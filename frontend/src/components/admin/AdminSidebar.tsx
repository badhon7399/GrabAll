    ...
    >
      ...
      <div className="px-5 py-5 border-b border-slate-800/60">
        <div className="flex items-center gap-3">
          <div className="relative w-9 h-9 rounded-xl bg-gradient-to-br from-[#0088FF] to-[#3B82F6] flex items-center justify-center shadow-lg shadow-[#0088FF]/25 flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="px-1.5 py-[2px] rounded-md text-[8px] font-black bg-gradient-to-r from-[#0088FF] to-[#3B82F6] text-white tracking-widest leading-none">
                OS
              </span>
            </div>
          ...
          <button className="relative w-8 h-8 rounded-lg bg-slate-800/60 hover:bg-slate-800 border border-slate-700/40 flex items-center justify-center transition-colors group">
            ...
            <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-[#0088FF] border border-slate-950" />
          </button>
        </div>
      </div>
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute left-0 top-1/4 bottom-1/4 w-[3px] rounded-r-full bg-gradient-to-b from-[#0088FF] to-[#3B82F6]"
                      ...
                      <div
                        className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 transition-all duration-200 ${isActive
                            ? 'bg-gradient-to-br from-[#0088FF]/20 to-[#3B82F6]/10 border border-[#0088FF]/30'
                            : 'bg-slate-800/60 border border-slate-700/30 group-hover:border-slate-600/40'
                          }`}
                      >
                        <span
                          className={`material-symbols-outlined text-[18px] transition-colors duration-200 ${isActive ? 'text-[#0088FF]' : 'text-slate-500 group-hover:text-slate-300'
                            }`}
                        >
                          {item.icon}
                        </span>
      ...
      <div className="px-4 py-4 border-t border-slate-800/60 bg-slate-950">
        <div className="flex items-center gap-3 p-2.5 rounded-xl bg-slate-900 border border-slate-800/60 mb-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-slate-700/60 flex items-center justify-center flex-shrink-0">
            <span className="material-symbols-outlined text-[#0088FF] text-[16px]">
          ...
          <span className="flex-shrink-0 px-1.5 py-0.5 rounded-md text-[8px] font-black bg-[#0088FF]/10 text-[#0088FF] border border-[#0088FF]/20 tracking-wider font-mono uppercase">
